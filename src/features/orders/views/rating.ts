export const genRatingView = (type: string) => (seller: {
	id: string,
	name: string,
	buyingRating: number,
	...
	'blocks': [
			...
			'element': {
				...
				'options': [
					...
					},
					{
						'text': {
							'type': 'plain_text',
							'text': "3 - Mediocre. This person wasn't particularly interesting.",
							'emoji': true
						},
						'value': '3'
					},
					...
					},
					{
						'text': {
							'type': 'plain_text',
							'text': '5 - Outstanding. This person is the manifestation of  human perfection.',
							'emoji': true
						},
						'value': '5'
					}
		...
		},
		{
			...
			'element': {
				...
				'placeholder': {
					'type': 'plain_text',
					'text': "Reasons for your rating. Remember to be constructive—everyone's human.",
					'emoji': true
				}
			},
			'label': {
...
const genRatedView = (type: string) => (rater: string, description: string, rating: number, currentRating: number) => ([
	{
		'type': 'section',
		'text': {
			'type': 'mrkdwn',
