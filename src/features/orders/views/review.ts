export const reviewOfferView = (order: {
	id: string,
	title: string,
	description: string,
	cost: number,
	...
	},
	{
		...
		'text': {
			'type': 'mrkdwn',
			'text': `*${seller.name} (<@${seller.id}>)*\nBuyer Rating (${seller.buyingRatingLength} ratings): ${Array(Math.round(seller.buyingRating)).fill('★').join('')} \n Seller Rating (${seller.sellingRatingLength} ratings): ${Array(Math.round(seller.sellingRating)).fill('★').join('') || '★'}\n Rated: ${seller.sellingRating} (S) / ${seller.buyingRating} (B)`
		},
		'accessory': {
			'type': 'image',
...
export const rejectedOrderView = (order: {
	id: string,
	title: string,
	description: string,
	cost: number,
...
export const approvedOrderView = (order: {
	id: string,
	title: string,
	description: string,
	cost: number,
