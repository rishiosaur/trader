import { marketReviewChannel, marketStreamChannel, token } from '../config'
...
export const postEphemeralUserCurry = (channel: string, user: string) => (
	blocks?: any[],
	text = ''
) =>
	app.client.chat.postEphemeral({
...
export const sendToReviewChannel = postMessageCurry(marketReviewChannel)
export const sendToStreamChannel = postMessageCurry(marketStreamChannel)
